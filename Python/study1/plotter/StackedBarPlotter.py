...
class StackedBarPlotter:
     def __init__(self, filename, title, dataDf, histDf, statDf):
        ...
        height=0.75
        fig, axs = pyplot.subplots(3, 1, sharey=False, sharex=False, figsize=(len(df.columns.values)+1, 5), gridspec_kw={'height_ratios': [0.75, 0.75, 1]})
        ...
        axs[0].legend( labels=[key for key in data], loc='upper center', frameon=False, bbox_to_anchor=(0.5, 1.3),fancybox=False, shadow=False, fontsize='small', ncol=len(data))
