...
variable_name_list = [
'INSECURE⇔SECURE', 'ANXIOUS⇔RELAXED', 'UNCOMFORTABLE⇔COMFORTABLE', 
'LACK_CONTROL⇔IN_CONTROL', 'THREATENING⇔SAFE', 'UNFAMILIAR⇔FAMILIAR', 
'UNRELIABLE⇔RELIABLE', 'SCARY⇔CALMING','OBSTRUCTIVE⇔SUPPORTIVE',
'COMPLICATED⇔EASY', 'INEFFICIENT⇔EFFICIENT', 'CONFUSING⇔CLEAR', 
'BORING⇔EXCITING', 'NOT_INTERESTING⇔INTERESTING', 'CONVENTIONAL⇔INVENTIVE',
'USUAL⇔LEADING_EDGE','UNPREDICTABLE⇔PREDICTABLE', 'EGOISTIC⇔ALTRUISTIC',
'PROTECTING_ROBOT⇔PROTECTING_USER'
]
variable_scale_list = [
    5, 5, 5,
    5, 5, 5,
