...
Shader "Outlined/DotOutlineShader" {
	Properties{
...
#pragma multi_compile_instancing
		...
		ENDCG
			...
			ENDCG
				...
				o.pos.xy += offset * o.pos.z * UNITY_ACCESS_INSTANCED_PROP(Props,_ThirdOutline);
			...
			// note that a vertex shader is specified here but its using the one above
				...
				o.pos.xy += offset * o.pos.z * UNITY_ACCESS_INSTANCED_PROP(Props,_FourthOutline);
				o.color = UNITY_ACCESS_INSTANCED_PROP(Props, _FourthOutlineColor);
				return o;
			}
			half4 frag(v2f i) :COLOR {
				UNITY_SETUP_INSTANCE_ID(i);
			...
			ENDCG
				...
				o.pos.xy += offset * o.pos.z * UNITY_ACCESS_INSTANCED_PROP(Props,_FifthOutline);
				o.color = UNITY_ACCESS_INSTANCED_PROP(Props, _FifthOutlineColor);
				return o;
			}
			half4 frag(v2f i) :COLOR {
				UNITY_SETUP_INSTANCE_ID(i);
