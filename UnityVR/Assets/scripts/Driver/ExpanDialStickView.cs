...
public class ExpanDialStickView : MonoBehaviour
{
	...
	void render()
	{
		...
		this.transform.localPosition = new Vector3(i * (diameter + offset), positionCurrentLerp, j * (diameter + offset));
		...
		this.transform.RotateAround(this.transform.localPosition - (this.transform.up * (height / 2)), Vector3.left, yAxisCurrentLerp);
		...
		this.transform.RotateAround(this.transform.localPosition - (this.transform.up * (height / 2)), Vector3.back, xAxisCurrentLerp);
		...
		planeGameObject.transform.localScale = new Vector3(this.planeSizeCurrent, 0.01f, this.planeSizeCurrent);
		planeGameObject.transform.localRotation = Quaternion.LookRotation(transform.forward, transform.up);
